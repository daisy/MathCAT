...
fn tensor_mmultiscripts() -> Result<()> {
    ...
    test_prefs("ru", "SimpleSpeak", vec![("Verbosity", "Verbose")], expr,
            "заглавная эр с 4 индексами после, нижний индекс и и верхний индекс нет нижний индекс нет и верхний индекс джей нижний индекс ка и верхний индекс нет нижний индекс эль и верхний индекс нет")?;
    test_prefs("ru", "SimpleSpeak", vec![("Verbosity", "Medium")], expr,
            "заглавная эр с 4 индексами после, нижний и и верхний нет нижний нет и верхний джей нижний ка и верхний нет нижний эль и верхний нет")?;
            return Ok(());
}
...
fn huge_num_mmultiscripts() -> Result<()> {
    ...
    test_prefs("ru", "SimpleSpeak", vec![("Verbosity", "Verbose")], expr,
            "заглавная эр с 4 индексами перед, левый нижний индекс заглавная и и левый верхний индекс нет, левый нижний индекс нет и левый верхний индекс заглавная джей, левый нижний индекс заглавная ка и левый верхний индекс нет, левый нижний индекс заглавная эль и левый верхний индекс нет и с 5 индексами после, нижний индекс и и верхний индекс нет нижний индекс нет и верхний индекс джей нижний индекс ка и верхний индекс нет нижний индекс эль и верхний индекс нет нижний индекс эм и верхний индекс нет")?;
            return Ok(());
}
