...
fn arc() -> Result<()> {
  ...
  test("el", "SimpleSpeak", expr, "τόξο κεφαλαίο b κεφαλαίο c")?;
  return Ok(());
...
fn ray() -> Result<()> {
  ...
  test("el", "SimpleSpeak", expr, "ευθύγραμμο τμήμα κεφαλαίο x κεφαλαίο y")?;
  return Ok(());
...
fn ray_mtext() -> Result<()> {
  ...
  test("el", "SimpleSpeak", expr, "διάνυσμα κεφαλαίο x κεφαλαίο y")?;
  return Ok(());
