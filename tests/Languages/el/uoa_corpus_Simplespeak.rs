...
fn uoa_corpus_033() -> Result<()> { //
 ...
 <mrow>
   ...
   <mo>−</mo><mi>ε</mi></mrow>
    ...
    return Ok(());
    //theodora. fails. needs genitive clause. Now reads: η τετραγωνική ρίζα το κλάσμα, βήτα προς, γάμμα συν δέλτα, τέλος κλάσματος; τέλος ρίζας; μείον έψιλον
}
...
fn uoa_corpus_332() -> Result<()> { //
 ...
 <mrow>
   ...
   <mo>−</mo><mi>ε</mi></mrow>
    ...
    test("el", "SimpleSpeak", expr, "η τετραγωνική ρίζα του κλάσμα, βήτα προς, c συν d, τέλος κλάσματος; τέλος ρίζας; μείον έψιλον")?;
    return Ok(());
}
