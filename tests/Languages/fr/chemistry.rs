...
fn salt() -> Result<()> {
  ...
  test_prefs("fr", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "n majuscule a, c majuscule l")?;
  return Ok(());
...
fn water() -> Result<()> {
  ...
  test_prefs("fr", "ClearSpeak", vec![("Verbosity", "Terse")], expr, "h majuscule, 2 o majuscule")?;
  test_prefs("fr", "ClearSpeak", vec![("Verbosity", "Medium")], expr, "h majuscule, indice 2, o majuscule")?;
  test_prefs("fr", "ClearSpeak", vec![("Verbosity", "Verbose")], expr, "h majuscule, indice 2, o majuscule")?;
  return Ok(());
...
fn carbon() -> Result<()> {
  ...
  test_prefs("fr", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "c majuscule")?;
  return Ok(());
...
fn sulfate() -> Result<()> {
  ...
  test_prefs("fr", "ClearSpeak", vec![("Verbosity", "Medium")], expr, "crochet ouvrant, s majuscule, o majuscule, indice 4; crochet fermant exposant 2 moins")?;
  return Ok(());
...
fn aluminum_sulfate() -> Result<()> {
  ...
  test_prefs("fr", "ClearSpeak", vec![("Verbosity", "Terse")], expr, "a majuscule l, 2; ouvert, s majuscule, o majuscule, 4; fermer 3")?;
  test_prefs("fr", "ClearSpeak", vec![("Verbosity", "Medium")], expr, "a majuscule l, indice 2; parenthèse gauche, s majuscule, o majuscule, indice 4; parenthèse droite indice 3")?;
  test_prefs("fr", "ClearSpeak", vec![("Verbosity", "Verbose")], expr, "a majuscule l, indice 2; parenthèse gauche, s majuscule, o majuscule, indice 4; parenthèse droite indice 3")?;
  return Ok(());
...
fn ethanol_bonds() -> Result<()> {
  ...
  test_prefs("fr", "ClearSpeak", vec![("Verbosity", "Terse")], expr, "c majuscule, h majuscule, 3, liaison simple c majuscule, h majuscule, 2, liaison simple o majuscule, h majuscule")?;
...
fn dichlorine_hexoxide() -> Result<()> {
  ...
  test_prefs("fr", "SimpleSpeak", vec![("Verbosity", "Terse")], 
    expr, "crochet ouvrant, c majuscule l, o majuscule, 2; crochet fermant plus; \
                          crochet ouvrant, c majuscule l, o majuscule, 4; crochet fermant moins")?;
  test_prefs("fr", "SimpleSpeak", vec![("Verbosity", "Medium")], 
    expr, "crochet ouvrant, c majuscule l, o majuscule, indice 2; crochet fermant exposant plus; \
                          crochet ouvrant, c majuscule l, o majuscule, indice 4; crochet fermant exposant moins")?;
...
fn ferric_chloride_aq() -> Result<()> {
  ...
  test_prefs("fr", "SimpleSpeak", vec![("Verbosity", "Terse")], expr, "f majuscule e, c majuscule l, 3, aqueux")?;
  return Ok(());
