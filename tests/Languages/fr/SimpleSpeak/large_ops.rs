...
fn sum_both() -> Result<()> {
    ...
    test("fr", "SimpleSpeak", expr, "la sommation de n est égal à 1, à 10 de n")?;
    return Ok(());
...
fn sum() -> Result<()> {
    ...
    test("fr", "SimpleSpeak", expr, "la sommation de a indice i")?;
    return Ok(());
...
fn product_both() -> Result<()> {
    ...
    test("fr", "SimpleSpeak", expr, "le produit de n est égal à 1, à 10 de n")?;
    return Ok(());
...
fn product() -> Result<()> {
    ...
    test("fr", "SimpleSpeak", expr, "le produit de a indice i")?;
    return Ok(());
...
fn integral_both() -> Result<()> {
    ...
    test("fr", "SimpleSpeak", expr, "l'intégrale de 0, à 1 de, f de x; d x")?;
    return Ok(());
...
fn integral_under() -> Result<()> {
    ...
    test("fr", "SimpleSpeak", expr, "l'intégrale sur les nombres réels de; f de x d x")?;
    return Ok(());
...
fn integral() -> Result<()> {
    ...
    test("fr", "SimpleSpeak", expr, "l'intégrale de f de x d x")?;
    return Ok(());
