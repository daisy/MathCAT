...
mod tests {
    ...
    #[test]
    fn move_simple_fraction_enhanced() -> Result<()> {
        let mathml_str = "<math id='id-0'>
        <mfrac id='id-1'> <mn id='id-2'>1</mn> <mn id='id-3'>2</mn> </mfrac>
            </math>";
        init_prefs(mathml_str, "Enhanced", "en");
        set_preference("SpeechStyle", "SimpleSpeak")?;
        return MATHML_INSTANCE.with(|package_instance| {
    ...
    #[test]
    fn move_simple_fraction_simple() -> Result<()> {
        let mathml_str = "<math id='id-0'>
        <mfrac id='id-1'> <mn id='id-2'>1</mn> <mn id='id-3'>2</mn> </mfrac>
            </math>";
        init_prefs(mathml_str, "Simple", "en");
    ...
    #[test]
    fn move_simple_fraction_character() -> Result<()> {
        let mathml_str = "<math id='id-0'>
        <mfrac id='id-1'> <mn id='id-2'>1</mn> <mn id='id-3'>2</mn> </mfrac>
            </math>";
        init_prefs(mathml_str, "Character", "en");
    ...
    #[test]
    fn move_fraction_enhanced() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0' >
        <mrow>
            <mfrac id='id-1'>
            <mrow id='id-2'>
        ...
        return MATHML_INSTANCE.with(|package_instance| {
            ...
            let speech = test_command("MoveNext", mathml, "id-6");
            assert_eq_with_panic_handler("move right; in denominator; x minus y", speech)?;
            let speech = test_command("MovePrevious", mathml, "id-2");
            assert_eq_with_panic_handler("move left; in numerator; x plus y", speech)?;
            let speech = test_command("ZoomIn", mathml, "id-3");
            assert_eq_with_panic_handler("zoom in; x", speech)?;
            let speech = test_command("MoveNext", mathml, "id-4");
            assert_eq_with_panic_handler("move right; plus", speech)?;
            let speech = test_command("MoveNext", mathml, "id-5");
            assert_eq_with_panic_handler("move right; y", speech)?;
            let speech = test_command("ZoomOut", mathml, "id-2");
            assert_eq_with_panic_handler("zoom out; x plus y", speech)?;
            let speech = test_command("MoveNext", mathml, "id-6");
            assert_eq_with_panic_handler("move right; in denominator; x minus y", speech)?;
            let speech = test_command("ZoomOut", mathml, "id-1");
            assert_eq_with_panic_handler(
    ...
    #[test]
    fn move_fraction_simple() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0' >
        <mrow>
            <mfrac id='id-1'>
            <mrow id='id-2'>
        ...
        return MATHML_INSTANCE.with(|package_instance| {
            ...
            let speech = test_command("MoveNext", mathml, "id-7");
            assert_eq_with_panic_handler("move right; in denominator; x", speech)?;

            let speech = test_command("MovePrevious", mathml, "id-5");
            assert_eq_with_panic_handler("move left; in numerator; y", speech)?;

            let speech = test_command("MoveNext", mathml, "id-7");
            assert_eq_with_panic_handler("move right; in denominator; x", speech)?;

            let speech = test_command("MoveNext", mathml, "id-8");
            assert_eq_with_panic_handler("move right; minus", speech)?;

            let speech = test_command("MoveNext", mathml, "id-9");
            assert_eq_with_panic_handler("move right; y", speech)?;

            let speech = test_command("ZoomOut", mathml, "id-6");
            assert_eq_with_panic_handler("zoom out; x minus y", speech)?;
    ...
    #[test]
    fn move_fraction_character() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0' >
        <mrow>
            <mfrac id='id-1'>
            <mrow id='id-2'>
    ...
    #[test]
    fn move_double_nested_fraction_enhanced() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0'>
    <mrow>
        <mfrac id='id-1'>
            <mrow id='id-2'>
        ...
        return MATHML_INSTANCE.with(|package_instance| {
            ...
            let speech = test_command("MoveNext", mathml, "id-7");
            assert_eq_with_panic_handler("move right; in denominator; 2 thirds", speech)?;
            ...
            assert_eq_with_panic_handler("zoom out; out of denominator; 2 thirds", speech)?;

            let speech = test_command("MovePrevious", mathml, "id-3");
            assert_eq_with_panic_handler("move left; in numerator; 1 half", speech)?;
    ...
    #[test]
    fn move_double_nested_fraction_simple() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0'>
    <mrow>
        <mfrac id='id-1'>
            <mrow id='id-2'>
    ...
    #[test]
    fn move_double_nested_fraction_character() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0'>
    <mrow>
        <mfrac id='id-1'>
            <mrow id='id-2'>
        ...
        return MATHML_INSTANCE.with(|package_instance| {
            ...
            let mathml = get_element(&package_instance);
            let speech = test_command("ZoomIn", mathml, "id-4");
            assert_eq_with_panic_handler("zoom in; in numerator; in numerator; 1", speech)?;
            ...
            let speech = test_command("MoveNext", mathml, "id-8");
            assert_eq_with_panic_handler("move right; in denominator; in numerator; 2", speech)?;

            let speech = test_command("MoveNext", mathml, "id-9");
            assert_eq_with_panic_handler("move right; in denominator; 3", speech)?;

            let speech = test_command("ZoomOut", mathml, "id-7");
            assert_eq_with_panic_handler("zoom out; out of denominator; 2 over 3", speech)?;

            let speech = test_command("MovePrevious", mathml, "id-5");
            assert_eq_with_panic_handler("move left; in numerator; in denominator; 2", speech)?;
    ...
    #[test]
    fn auto_zoom_out_nested_fractions_enhanced() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0'>
    <mrow>
        <mfrac id='id-1'>
            <mrow id='id-2'>
    ...
    #[test]
    fn auto_zoom_out_nested_fractions_simple() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0'>
    <mrow>
        <mfrac id='id-1'>
            <mrow id='id-2'>
    ...
    #[test]
    fn auto_zoom_out_nested_fractions_character() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0'>
    <mrow>
        <mfrac id='id-1'>
            <mrow id='id-2'>
        ...
        return MATHML_INSTANCE.with(|package_instance| {
            ...
            let speech = test_command("MoveNext", mathml, "id-8");
            assert_eq_with_panic_handler(
                "move right; out of denominator; in denominator; in numerator; 2",
                speech,
            )?;

            let speech = test_command("MovePrevious", mathml, "id-5");
            assert_eq_with_panic_handler(
                "move left; out of numerator; in numerator; in denominator; 2",
                speech,
            )?;
    ...
    #[test]
    fn zoom_all_nested_fraction_enhanced() -> Result<()> {
    ...
    <mrow id='id-0'>
        ...
        return MATHML_INSTANCE.with(|package_instance| {
            let package_instance = package_instance.borrow();
            let mathml = get_element(&package_instance);
            let speech = test_command("ZoomInAll", mathml, "id-4");
            assert_eq_with_panic_handler(
                "zoomed in all of the way; in numerator; in numerator; 1",
                speech,
            )?;
    ...
    #[test]
    fn zoom_all_nested_fraction_simple() -> Result<()> {
        let mathml_str = "<math display='block' id='math'>
    <mrow id='id-0'>
        <mfrac id='id-1'>
            <mrow id='id-2'>
    ...
    #[test]
    fn zoom_all_nested_fraction_character() -> Result<()> {
        let mathml_str = "<math display='block' id='math'>
    <mrow id='id-0'>
        <mfrac id='id-1'>
            <mrow id='id-2'>
    ...
    #[test]
    fn move_simple_power_enhanced() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0' >
        <msup id='id-1'>
        <mi id='id-2'>x</mi>
        <mn id='id-3'>2</mn>
        ...
        return MATHML_INSTANCE.with(|package_instance| {
            ...
            let speech = test_command("ZoomOut", mathml, "id-1");
            assert_eq_with_panic_handler("zoom out; out of base; x squared", speech)?;
    ...
    #[test]
    fn move_simple_power_simple() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0' >
    <msup id='id-1'>
        <mi id='id-2'>x</mi>
        <mn id='id-3'>2</mn>
    ...
    #[test]
    fn move_simple_power_character() -> Result<()> {
        let mathml_str = "<math display='block' id='id-0' >
    <msup id='id-1'>
        <mi id='id-2'>x</mi>
        <mn id='id-3'>2</mn>
        ...
        return MATHML_INSTANCE.with(|package_instance| {
            ...
            let speech = test_command("ZoomOut", mathml, "id-1");
            assert_eq_with_panic_handler("zoom out; out of base; x super 2 end super", speech)?;
